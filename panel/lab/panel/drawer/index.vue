<template>
	<k-lab-examples>
		...
		<k-lab-example label="close" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.close();</k-lab-code>
				<p>Closes the current drawer</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="goTo" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.goTo(id);</k-lab-code>
				<p>Opens one of the drawers in the history by ID</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="input" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.input(value);</k-lab-code>
				<p>Triggers an input event and updates the value prop</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="load" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.load(url);</k-lab-code>
				<p>Loads the state for a drawer by URL</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="open" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.open(drawer);</k-lab-code>
				<p>Opens a drawer either via object definition or URL</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="openTab" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.openTab(tabId);</k-lab-code>
		...
		<k-lab-example label="post" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.drawer.post(value, options = {});</k-lab-code
				>
		...
		<k-lab-example label="refresh" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.drawer.refresh(options = {});</k-lab-code
				>
		...
		<k-lab-example label="reload" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.drawer.reload(options = {});</k-lab-code
				>
		...
		<k-lab-example label="set" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.set(state);</k-lab-code>
				<p>Overwrites the current drawer state</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="state" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.state();</k-lab-code>
		...
		<k-lab-example label="submit" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.drawer.submit(value, options = {});</k-lab-code
				>
		...
		<k-lab-example label="success" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.drawer.success(success);</k-lab-code
				>
		...
		<k-lab-example label="url" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.drawer.url();</k-lab-code>
				<p>
