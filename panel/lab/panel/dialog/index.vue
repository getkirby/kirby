<template>
	<k-lab-examples>
		...
		<k-lab-example label="close" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.dialog.close();</k-lab-code>
				<p>Closes the current dialog</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="input" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.dialog.input(value);</k-lab-code>
				<p>Triggers an input event and updates the value prop</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="load" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.dialog.load(url);</k-lab-code>
				<p>Loads the state for a dialog by URL</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="open" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.dialog.open(dialog);</k-lab-code>
		...
		<k-lab-example label="post" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.dialog.post(value, options = {});</k-lab-code
				>
		...
		<k-lab-example label="refresh" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.dialog.refresh(options = {});</k-lab-code
				>
		...
		<k-lab-example label="reload" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.dialog.reload(options = {});</k-lab-code
				>
		...
		<k-lab-example label="set" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.dialog.set(state);</k-lab-code>
				<p>Overwrites the current dialog state</p>
			</k-text>
		</k-lab-example>
		<k-lab-example label="state" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.dialog.state();</k-lab-code>
		...
		<k-lab-example label="submit" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.dialog.submit(value, options = {});</k-lab-code
				>
		...
		<k-lab-example label="success" :code="false">
			<k-text>
				<k-lab-code language="js"
					>window.panel.dialog.success(success);</k-lab-code
				>
		...
		<k-lab-example label="url" :code="false">
			<k-text>
				<k-lab-code language="js">window.panel.dialog.url();</k-lab-code>
				<p>
