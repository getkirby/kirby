	...
	<k-lab-examples>
		<k-lab-example :flex="true" label="default">
			<k-button
				icon="checklist"
				variant="filled"
				@click="$refs.picklist1.toggle()"
			>
				Select
			</k-button>
			<k-picklist-dropdown ref="picklist1" :options="options" />
		</k-lab-example>

		<k-lab-example :flex="true" label="multiple: false">
			<k-button
				icon="checklist"
				variant="filled"
				@click="$refs.picklist2.toggle()"
			>
				Select
			</k-button>
			<k-picklist-dropdown
		...
		<k-lab-example :flex="true" label="create">
			<k-button
				icon="checklist"
				variant="filled"
				@click="$refs.picklist3.toggle()"
			>
				Select
			</k-button>
			<k-picklist-dropdown ref="picklist3" :create="true" :options="options" />
		</k-lab-example>

		<k-lab-example :flex="true" label="max: 2">
			<k-button
				icon="checklist"
				variant="filled"
				@click="$refs.picklist4.toggle()"
			>
				Select
			</k-button>
			<k-picklist-dropdown
		...
		<k-lab-example :flex="true" label="search: display limited">
			<k-button
				icon="checklist"
				variant="filled"
				@click="$refs.picklist5.toggle()"
			>
				Select
			</k-button>
			<k-picklist-dropdown
		...
		<k-lab-example :flex="true" label="search: false">
			<k-button
				icon="checklist"
				variant="filled"
				@click="$refs.picklist6.toggle()"
			>
				Select
			</k-button>
			<k-picklist-dropdown ref="picklist6" :options="options" :search="false" />
		</k-lab-example>
	</k-lab-examples>
</template>
	...
	computed: {
		...
		optionsMany() {
			return [
				...
				{ text: "Antigua & Deps", value: "Antigua & Deps" },
				...
				{ text: "Congo {Democratic Rep}", value: "Congo {Democratic Rep}" },
				...
				{ text: "Ireland {Republic}", value: "Ireland {Republic}" },
