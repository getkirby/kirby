<template>
	<k-ui-examples>
		...
		<k-ui-example label="Text alignment">
			<div class="k-table">
				<table>
					<thead>
						<tr>
		...
		<k-ui-example label="Index with sort handle">
			<div class="k-table">
				<table>
					<thead>
						<tr>
