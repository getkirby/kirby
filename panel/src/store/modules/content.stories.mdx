...
The content store is home for all values from the model's content file as well as unsaved changes and meta information about things such as content locking. A model in this context can refer to a page, a file or a user.
