...
export const props = {
	mixins: [InputProps, SelectorProps],
	props: {
		draggable: {
			default: true,
			type: Boolean
...
<style>
:root {
	--tags-input-gap: 0.375rem;
}
.k-tags-input {
	display: block;
}
.k-tags-input-navigation {
