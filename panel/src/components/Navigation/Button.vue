...
export const props = {
	...
	props: {
		...
		link: String,
		/**
		 * Path of an endpoint to send a request to on click. Pass an object
		 * to control the request further, e.g. `{ url, method, body, query }`
		 * @since 6.0.0
		 */
	...
	methods: {
		...
		async send() {
			...
			try {
				 ...
				 * @property {Object} json the parsed response body
				 */
