<template>
  <!-- eslint-disable -->
  <svg v-once aria-hidden="true" style="position:absolute;width:0;height:0" xmlns="http://www.w3.org/2000/svg" overflow="hidden">
    <defs>
      ...
      <symbol id="icon-file-binary" viewBox="0 0 12 16">
        <path d="M4 12h1v1H2v-1h1v-2H2V9h2v3zm8-7.5V14c0 .55-.45 1-1 1H1c-.55 0-1-.45-1-1V2c0-.55.45-1 1-1h7.5L12 4.5zM11 5L8 2H1v12h10V5zM8 4H6v1h1v2H6v1h3V7H8V4zM2 4h3v4H2V4zm1 3h1V5H3v2zm3 2h3v4H6V9zm1 3h1v-2H7v2z"
        />
      </symbol>
      <symbol id="icon-file-checklist" viewBox="0 0 16 16">
        <path d="M16 8.5l-6 6-3-3L8.5 10l1.5 1.5L14.5 7 16 8.5zM5.7 12.2l.8.8H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h7c.55 0 1 .45 1 1v6.5l-.8-.8c-.39-.39-1.03-.39-1.42 0L5.7 10.8a.996.996 0 0 0 0 1.41v-.01zM4 4h5V3H4v1zm0 2h5V5H4v1zm0 2h3V7H4v1zM3 9H2v1h1V9zm0-2H2v1h1V7zm0-2H2v1h1V5zm0-2H2v1h1V3z"
        />
      </symbol>
      <symbol id="icon-file-code" viewBox="0 0 12 16">
      ...
      <symbol id="icon-file-directory" viewBox="0 0 14 16">
        <path d="M13 4H7V3c0-.66-.31-1-1-1H1c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1zM6 4H1V3h5v1z"
        />
      </symbol>
      <symbol id="icon-file-media" viewBox="0 0 12 16">
        <path d="M6 5h2v2H6V5zm6-.5V14c0 .55-.45 1-1 1H1c-.55 0-1-.45-1-1V2c0-.55.45-1 1-1h7.5L12 4.5zM11 5L8 2H1v11l3-5 2 4 2-2 3 3V5z"
        />
      </symbol>
      <symbol id="icon-file-pdf" viewBox="0 0 12 16">
        <path d="M8.5 1H1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V4.5L8.5 1zM1 2h4a.68.68 0 0 0-.31.2 1.079 1.079 0 0 0-.23.47 4.229 4.229 0 0 0-.09 1.47c.06.609.173 1.211.34 1.8-.311.91-.682 1.799-1.11 2.66-.5 1-.8 1.66-.91 1.84a7.263 7.263 0 0 0-.69.3c-.362.165-.699.38-1 .64V2zm4.42 4.8a5.648 5.648 0 0 0 1.17 2.09c.275.237.595.417.94.53-.64.09-1.23.2-1.81.33-.618.149-1.223.347-1.81.59s.22-.44.61-1.25c.365-.741.67-1.51.91-2.3l-.01.01zM11 14H1.5a.69.69 0 0 1-.17 0c.271-.096.519-.245.73-.44a10.152 10.152 0 0 0 1.78-2.38c.31-.13.58-.23.81-.31l.42-.14c.45-.13.94-.23 1.44-.33s1-.16 1.48-.2c.447.216.912.394 1.39.53.403.111.814.188 1.23.23h.38V14H11zm0-4.86a3.717 3.717 0 0 0-.64-.28 4.214 4.214 0 0 0-.75-.11c-.411.003-.822.03-1.23.08a2.996 2.996 0 0 1-1-.64 6.07 6.07 0 0 1-1.29-2.33c.111-.661.178-1.33.2-2 .019-.25.019-.5 0-.75a1.05 1.05 0 0 0-.2-.88.82.82 0 0 0-.61-.23H8l3 3v4.14z"
        />
      </symbol>
      <symbol id="icon-file-submodule" viewBox="0 0 14 16">
        <path d="M10 7H4v7h9c.55 0 1-.45 1-1V8h-4V7zM9 9H5V8h4v1zm4-5H7V3c0-.66-.31-1-1-1H1c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h2V7c0-.55.45-1 1-1h6c.55 0 1 .45 1 1h3V5c0-.55-.45-1-1-1zM6 4H1V3h5v1z"
        />
      </symbol>
      <symbol id="icon-file-symlink-directory" viewBox="0 0 14 16">
        <path d="M13 4H7V3c0-.66-.31-1-1-1H1c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1zM1 3h5v1H1V3zm6 9v-2c-.98-.02-1.84.22-2.55.7S3.26 11.95 3 13c.02-1.64.39-2.88 1.13-3.73C4.86 8.43 5.82 8 7.01 8V6l4 3-4 3H7z"
        />
      </symbol>
      <symbol id="icon-file-symlink-file" viewBox="0 0 12 16">
        <path d="M8.5 1H1c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h10c.55 0 1-.45 1-1V4.5L8.5 1zM11 14H1V2h7l3 3v9zM6 4.5l4 3-4 3v-2c-.98-.02-1.84.22-2.55.7S2.26 10.45 2 11.5c.02-1.64.39-2.88 1.13-3.73.73-.84 1.69-1.27 2.88-1.27v-2H6z"
        />
      </symbol>
      <symbol id="icon-file-text" viewBox="0 0 12 16">
      ...
      <symbol id="icon-file-zip" viewBox="0 0 12 16">
        <path d="M8.5 1H1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V4.5L8.5 1zM11 14H1V2h3v1h1V2h3l3 3v9zM5 4V3h1v1H5zM4 4h1v1H4V4zm1 2V5h1v1H5zM4 6h1v1H4V6zm1 2V7h1v1H5zM4 9.28A2 2 0 0 0 3 11v1h4v-1a2 2 0 0 0-2-2V8H4v1.28zM6 10v1H4v-1h2z"
        />
      </symbol>
      ...
      <symbol id="icon-toggle-on" viewBox="0 0 16 16">
        <path d="M11 3H5C2.2 3 0 5.2 0 8s2.2 5 5 5h6c2.8 0 5-2.2 5-5s-2.2-5-5-5zm-6 8c-1.7 0-3-1.3-3-3s1.3-3 3-3 3 1.3 3 3-1.3 3-3 3z"
        />
      </symbol>
