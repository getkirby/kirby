...
abstract class Challenge
{
	...
	/**
	 * Returns the form component definition for this challenge's verification step
	 * @codeCoverageIgnore
	 */
	public function form(Pending $pending): Component|array
	{
		return [];
	}
	 ...
	 * the challenge, e.g. on the login view
	 */
	...
	/**
	 * Returns the submit button definition for the challenge form
	 */
