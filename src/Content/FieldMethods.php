...
/**
 * Field methods can be registered for \Kirby\Content\Field
 * objects (which this trait is used for). The field methods
 * can then be used to transform or convert the field value.
 * This enables our daisy-chaining API for templates and
 * other components
 *
 * ```php
