...
class Field extends Component
{
	...
	{
		return static::$types[$this->type][$option] ?? $fallback;
	}
	...
	public function props(): array
	{
		...
		// set properties manually that should not be
		// auto-generated by the weird component class logic
		$props['disabled'] = $this->isDisabled();
		$props['hidden']   = $this->isHidden();
		$props['name']     = $this->name();
		$props['required'] = $this->isRequired();
		$props['saveable'] = $this->isSaveable();
