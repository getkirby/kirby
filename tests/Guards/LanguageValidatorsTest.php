...
class LanguageValidatorsTest extends ModelTestCase
{
	...
	public function testDefault(): void
	{
		...
		$this->assertNull($validators->validateDefault());
	}

	public function testDefaultWithExistingDefaultLanguage(): void
	{
		...
		$this->expectExceptionCode('error.language.create.default');

		$validators->validateDefault();
	}

	public function testDefaultWithNonDefaultLanguage(): void
	{
		$this->app = $this->app->clone([
			'languages' => [
				['code' => 'en', 'name' => 'English', 'default' => true]
	...
	public function testEnsureCreateWithExistingDefaultLanguage(): void
	{
		$this->app = $this->app->clone([
			'languages' => [
				['code' => 'en', 'name' => 'English', 'default' => true]
