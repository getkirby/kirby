...
class ImageTagTest extends TestCase
{
	...
	public function testRenderWithClasses(): void
	{
		$this->app->clone();
		...
		$expected = '<figure><a class="link" href="/myimage.jpg"><img alt="" class="img" src="/myimage.jpg"></a></figure>';

		$this->assertSame($expected, $tag->render());
	}

	public function testRenderWithClassesLowercase(): void
	{
		$this->app->clone();

		// the attributes are written lowercase in KirbyText,
		// no matter how the constructor arguments are spelled
		$tag = KirbyTag::parse('(image: myimage.jpg imgclass: img link: self linkclass: link)');

		$expected = '<figure><a class="link" href="/myimage.jpg"><img alt="" class="img" src="/myimage.jpg"></a></figure>';

		$this->assertSame($expected, $tag->render());
		$this->assertSame('img', $tag->imgClass);
		$this->assertSame('link', $tag->linkClass);
	}
