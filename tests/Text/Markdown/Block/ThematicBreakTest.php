...
#[CoversClass(ThematicBreak::class)]
class ThematicBreakTest extends TestCase
{
	protected ThematicBreak $block;

	public function setUp(): void
	{
		$this->block = new ThematicBreak(new Parser());
	}

	public function testMarkers(): void
	{
		$this->assertMarkersDispatchComponent(ThematicBreak::class);
	}
