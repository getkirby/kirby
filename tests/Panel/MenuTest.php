...
class MenuTest extends TestCase
{
	...
	public function test__ConstructConfig(): void
	{
		$menu = new Menu(config: ['site', 'users']);
		$this->assertSame(['site', 'users'], $menu->config);
	}

	public function test__ConstructConfigDefaults(): void
	{
		$menu = new Menu();
		$this->assertSame(['site', 'languages', 'users', 'system'], $menu->config);
	}
	...
	public function testAreas(): void
	{
		...
		$this->assertSame($areas, $menu->areas());
	}

	public function testCurrent(): void
	{
		$menu = new Menu(current: 'site');
		$this->assertSame('site', $menu->current());
	}

	// public function testDefaultsOrder(): void
	// {
	// 	$menu = new Menu(
	// 		areas: [
	// 			'foo' => [
	...
	// 	$this->assertSame(['site', 'foo'], $defaults);
	// }
