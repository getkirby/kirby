...
class XmlTest extends TestCase
{
	...
	public static function valueProvider(): array
	{
		return [
			...
			['<![CDATA[test]]><![CDATA[more]]>', '<![CDATA[test]]><![CDATA[more]]>'],
			['<![CDATA[<tag>&x]]><![CDATA[more]]>', '<![CDATA[<tag>&x]]><![CDATA[more]]>'],
			['<![CDATA[ ]]><juhu>haha</juhu>', '<![CDATA[<![CDATA[ ]]]]><![CDATA[><juhu>haha</juhu>]]>'],
			['<![CDATA[test', '<![CDATA[<![CDATA[test]]>'],
			['<![CDATA[test]]>foo', '<![CDATA[<![CDATA[test]]]]><![CDATA[>foo]]>'],
			['<![CDATA[test]]><!-- x -->', '<![CDATA[<![CDATA[test]]]]><![CDATA[><!-- x -->]]>'],
			['<![CDATA[test]]><![CDATA[more]]>tail', '<![CDATA[<![CDATA[test]]]]><![CDATA[><![CDATA[more]]]]><![CDATA[>tail]]>'],
			['prefix<![CDATA[test]]>', '<![CDATA[prefix<![CDATA[test]]]]><![CDATA[>]]>'],
			['<![CDATA[test]]><![CDATA[more', '<![CDATA[<![CDATA[test]]]]><![CDATA[><![CDATA[more]]>'],
			['test', 'test'],
